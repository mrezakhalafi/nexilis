...
<body>
    ...
    <div class="container-fluid section-menu">
        <ul class="nav nav-tabs horizontal-slide gx-0">
            ...
            <li class="nav-item p-2 selected" style="width: 100px; background-color: #e6e6e6" onclick="navData()">
                <img class="img-slider" src="https://images.tokopedia.net/img/SnKlQx/2022/2/2/3f060ab5-9a19-43e5-bbe1-d1bd21c274ed.png">
        ...
        <div class="container p-2">
            <div class="row gx-0 mt-3" style="background-color: #f0f3f7; border-radius: 8px; margin-left: 7px; margin-right: 7px; height: 38px">
                <div class="col-12 text-center">
                    ...
                    if ($env == 1) {
                    ?>
                        <div id="paketdata" style="margin:4px; background-color: #f06270; color: #FFFFFF; border-radius: 8px; font-size: 15px; height: 30px; padding-top: 3px">Paket Data</div>
                    <?php
                    } else {
                    ?>
                        <div id="paketdata" style="margin:4px; background-color: red; color: #FFFFFF; border-radius: 8px; font-size: 15px; height: 30px; padding-top: 3px">Paket Data</div>
                    <?php
                    }
                    ?>
                </div>
    ...
    <div class="container-fluid section-promo mt-2 pt-2 pb-2">
            ...
            <div class="col-12 justify-content-center">
                <div class="row gx-0">
                    <div class="col-12 p-4 d-flex justify-content-center">
                        ...
                        if ($env == 1) {
                        ?>
                            <h3 class="mb-0 mt-2" style="font-weight: 700; font-size: 20px">Pengalaman beli paket data di <span><img src="../assets/img/Virtoo Assets-20220420T065146Z-001/GTM 2.0-Virtoo Assets/Logo/Virtoo_Gradient.png" alt="" style="height: 70px; width: 70px; margin-top: -2px; margin-left: -5px"></span></h3>
                        <?php
                        } else {
                        ?>
                            <h3 class="mb-0 mt-2" style="font-weight: 700; font-size: 20px">Pengalaman beli paket data di <span style="font-size: 20px; color: red">DigiPos</span></h3>
                        <?php
                        }
                        ?>
                    </div>
        ...
        <div class="row gx-0 mt-5">
            <div class="col-12 d-flex justify-content-center text-center">
                ...
                if ($env == 1) {
                ?>
                    <p style="font-size: 14px; color: grey">Isi Paket Data Online Murah, Cepat, Mudah &amp; Aman <br /> Mulai Aja Dulu di <span><img src="../assets/img/Virtoo_Gradient.png" alt="" style="height: 50px; width: 50px; margin-top: -2px; margin-left: -3px"></span></p>
                <?php
                } else {
                ?>
                    <p style="font-size: 14px; color: grey">Isi Paket Data Online Murah, Cepat, Mudah &amp; Aman <br /> Mulai Aja Dulu di <span style="font-size: 14px; font-weight: 700; color: red">DigiPos</span></p>
                <?php
                }
                ?>
            </div>
        ...
        <div class="col-12 d-flex justify-content-center">
            <div class="row gx-0 p-3" style="width: 100%; margin-top: -15px">
                ...
                <div class="col-6 d-flex justify-content-end">
                    ...
                    if ($env == 1) {
                    ?>
                        <button id="paid-text" style="background-color: #f06270" class="btn text-light" onclick="purchasePulsa()">Bayar</button>
                    <?php
                    } else {
                    ?>
                        <button id="paid-text" style="background-color: red" class="btn text-light" onclick="purchasePulsa()">Bayar</button>
                    <?php
                    }
                    ?>
                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Object.keys(obj).forEach(function(item) {
                            ...
                            <div class="pulsa-box shadow text-center" data-product="` + obj[item]['CODE'] + `" data-price="` + obj[item]['NEW_PRICE'] + `" style="border-radius: 10px; padding: 10px; padding-top: 25px !important">
...
<script src="../assets/js/cart_digipos.js?v=<?php echo $ver; ?>"></script>