...
<body>
    ...
    <div class="section-menu">
        <ul class="nav nav-tabs horizontal-slide gx-0">
            ...
            <li class="nav-item p-2 selected" style="width: 100px; background-color: #e6e6e6" onclick="navPesawat()">
    ...
    <div class="container p-2" style="margin-top: -160px">
        <div class="row gx-0 mt-3" style="background-color: #f0f3f7; border-radius: 8px; margin-left: 7px; margin-right: 7px; height: 38px">
            <div class="col-12 text-center">
                ...
                if ($env == 1) {
                ?>
                    <div id="pesawat" style="margin:4px; background-color: #f06270; color: #FFFFFF; border-radius: 8px; font-size: 15px; height: 30px; padding-top: 3px">Pesawat</div>
                <?php
                } else {
                ?>
                    <div id="pesawat" style="margin:4px; background-color: red; color: #FFFFFF; border-radius: 8px; font-size: 15px; height: 30px; padding-top: 3px">Pesawat</div>
                <?php
                }
                ?>
            </div>
    ...
    <div class="container p-2">
        <div id="train-schedule" class="row p-3 mb-2 shadow" style="background-color: #FFFFFF; border-radius: 8px; margin-left: 7px; margin-right: 7px; margin-top: 5px">
            <div class="col-12 d-flex justify-content-start p-2">
                <h1 class="mb-0" style="font-size: 18px; font-weight: 600">Beli Tiket Pesawat</h1>
            </div>
            ...
            <div class="row gx-0 p-2 pb-3" style="border-bottom: 1px solid var(--N75,#E5E7E9)">
                <div id="pergi" class="col-5">
                    ...
                    <br>
                    <p id="kota-asal" class="mb-0" style="margin-top: -27px; font-size: 25px; font-weight: 700">CGK</p>
                    <br>
                    <p id="kode-kota" class="mb-0" style="margin-top: -27px; font-size: 14px">Soekarno Hatta</p>
                </div>
                <div class="col-2 p-3">
                ...
                <div id="balik" class="col-5">
                    ...
                    <br>
                    <p id="kota-tujuan" class="mb-0 text-end" style="margin-top: -27px; font-size: 25px; font-weight: 700">BNK</p>
                    <br>
                    <p id="kode-kota-2" class="mb-0 text-end" style="margin-top: -27px; font-size: 14px">Ballina Byron Gateway</p>
                </div>
            </div>
        ...
        <div id="section-penumpang" class="row p-3 mb-2 shadow" style="background-color: #FFFFFF; border-radius: 8px; margin-left: 7px; margin-right: 7px; margin-top: 5px">
            ...
            <div id="section-data-pemesan" class="row gx-0">
                ...
                <div class="col-12 text-center">
                    ...
                    if ($env == 1) {
                    ?>
                        <div id="btn-data-pemesan" class="btn text-light mt-3 mb-4 w-50" style="width: 100%; background-color: #f06270" onclick="isiDataPemesan()">Isi Data Pemesan</div>
                    <?php
                    } else {
                    ?>
                        <div id="btn-data-pemesan" class="btn text-light mt-3 mb-4 w-50" style="width: 100%; background-color: red" onclick="isiDataPemesan()">Isi Data Pemesan</div>
                    <?php
                    }
                    ?>
                </div>
            ...
            <div id="modal-content-penumpang" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" style="text-transform: capitalize" disabled placeholder="Cari Bandara..." id="cari-bandara-berangkat">
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <p style="font-size: 18px; font-weight: 800">BANDARA POPULER</p>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modal-pulang" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div id="modal-content-penumpang" class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" style="text-transform: capitalize" disabled placeholder="Cari Bandara..." id="cari-bandara-pulang">
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <p style="font-size: 18px; font-weight: 800">BANDARA POPULER</p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mt-3">
                        <input type="number" class="form-control" id="card_number_pemesan" placeholder="Identity Number (KTP/Paspor)">
                    </div>
                    <small id="card_number_pemesan_error" class="text-danger d-none">This field is required.</small>
                    <div class="input-group mt-3">
                        <small style="margin-right: 20px">Card Issue Date :</small>
                        <input type="date" class="form-control" id="issue_date_pemesan">
                    </div>
                    <small id="issue_date_pemesan_error" class="text-danger d-none">This field is required.</small>
                    <div class="input-group mt-3">
                        <small style="margin-right: 20px">Card Expiry Date :</small>
                    ...
                    <select class="form-select mt-3" id="luggage_pemesan" aria-label="Default select example">
                        <option value="" selected>Luggage</option>
                        <option value="1">Small</option>
                        <option value="2">Large</option>
                    </select>
                    <small id="luggage_pemesan_error" class="text-danger d-none">This field is required.</small>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mt-3">
                        <input type="number" class="form-control" id="card_number_penumpang" placeholder="Identity Number (KTP/Paspor)">
                    </div>
                    <small id="card_number_penumpang_error" class="text-danger d-none">This field is required.</small>
                    <div class="input-group mt-3">
                        <small style="margin-right: 20px">Card Issue Date :</small>
                        <input type="date" class="form-control" id="issue_date_penumpang">
                    </div>
                    <small id="issue_date_penumpang_error" class="text-danger d-none">This field is required.</small>
                    <div class="input-group mt-3">
                        <small style="margin-right: 20px">Card Expiry Date :</small>
                    ...
                    <select class="form-select mt-3" id="luggage_penumpang" aria-label="Default select example">
                        <option value="" selected>Luggage</option>
                        <option value="1">Small</option>
                        <option value="2">Large</option>
                    </select>
                    <small id="luggage_penumpang_error" class="text-danger d-none">This field is required.</small>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <?php
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="plane-info">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <b>Nomor Penerbangan :</b>
                        </div>
                        <div class="col-6">
                            <p id="details-flight-number"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
...
<script>
    ...
    function getAirport() {
        ...
        xmlHttp.onreadystatechange = function() {
            ...
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                obj = JSON.parse(xmlHttp.responseText).data;
                ...
                $('#kota-asal').text(obj[1114]['code']);
                $('#kode-kota').text(obj[1114]['name']);
                $('#kota-tujuan').text(obj[92]['code']);
                $('#kode-kota-2').text(obj[92]['name']);

                $('#loading-1').hide();
                $('#loading-2').hide();

                $('#cari-bandara-berangkat').attr('disabled', false);
                $('#cari-bandara-pulang').attr('disabled', false);
    ...
    $("#cari-bandara-berangkat").bind("change paste keyup", function() {
    ...
    $("#cari-bandara-pulang").bind("change paste keyup", function() {
    ...
    function selectStart(start_short, start_long, plane_class) {

        var station_short = start_short;
        var station_long = start_long;
        var start_class = plane_class;
    ...
    function selectEnd(end_short, end_long, plane_class) {

        var station_short = end_short;
        var station_long = end_long;
        var end_class = plane_class;
    ...
    function simpanPemesan() {
        ...
        var card_issue_date = $('#issue_date_pemesan').val();
        var luggage = $('#luggage_pemesan').val();
        ...
        if (!card_issue_date) {
            $('#issue_date_penumpang_error').removeClass('d-none');
        } else {
            $('#issue_date_penumpang_error').addClass('d-none');
        }

        if (!luggage) {
            $('#luggage_pemesan_error').removeClass('d-none');
        } else {
            $('#luggage_pemesan_error').addClass('d-none');
        }

        if (first_name && last_name && email && phone && salutation && type && birth_date && nationality && card_number && card_expiry_date && card_issue_date && luggage) {
    ...
    function simpanPenumpang() {
        ...
        var card_issue_date = $('#issue_date_penumpang').val();
        var luggage = $('#luggage_penumpang').val();
        ...
        if (!luggage) {
            $('#luggage_penumpang_error').removeClass('d-none');
        } else {
            $('#luggage_penumpang_error').addClass('d-none');
        }
        ...
        if (first_name && last_name && email && phone && salutation && type && birth_date && nationality && card_number && card_expiry_date && card_issue_date && luggage) {
            ...
            $('#issue_date_penumpang').val("");
            $('#luggage_penumpang').val("");
