...
$sqlData = "SELECT * FROM PPOB_PRODUCT WHERE TYPE = 12 ORDER BY ABS(DENOM) ASC";

$queDATA = $dbconn->prepare($sqlData);
$queDATA->execute();
$bulan = $queDATA->get_result();
$queDATA->close();
...
<body>
    ...
    <div class="container-fluid section-menu">
        <ul class="nav nav-tabs horizontal-slide gx-0">
            ...
            <li class="nav-item p-2 selected" style="width: 100px; background-color: #e6e6e6" onclick="navBPJS()">
    ...
    <div class="row gx-0" style="height: 570px">
            ...
            <div class="container-fluid section-main">
                <div class="container p-2">
                    <div class="row gx-0 mt-3" style="background-color: #f0f3f7; border-radius: 8px; margin-left: 7px; margin-right: 7px; height: 38px">
                        <div class="col-12 text-center" onclick="navKesehatan()">
                            ...
                            if ($env == 1) {
                            ?>
                                <div id="bpjs" style="margin:4px; background-color: #f06270; color: #FFFFFF; border-radius: 8px; font-size: 15px; height: 30px; padding-top: 3px">BPJS</div>
                            <?php
                            } else {
                            ?>
                                <div id="bpjs" style="margin:4px; background-color: red; color: #FFFFFF; border-radius: 8px; font-size: 15px; height: 30px; padding-top: 3px">BPJS</div>
                            <?php
                            }
                            ?>
                        </div>
                ...
                <div class="container p-2">
                    <div class="row p-3 mb-2 shadow" style="background-color: #FFFFFF; border-radius: 8px; margin-left: 7px; margin-right: 7px; margin-top: 5px">
                        ...
                        <input type="radio" id="radiokesehatan" name="radiobpjs" class="form-check-input" value="1" checked>&nbsp;<label for="radiokesehatan" style="margin-top: 5px; font-size: 10px; font-weight: 700">Kesehatan</label> &nbsp; &nbsp;
                        <input type="radio" id="radiodenda" name="radiobpjs" class="form-check-input" value="2">&nbsp;<label for="radiodenda" style="margin-top: 5px; font-size: 10px; font-weight: 700">BPJS Denda</label> &nbsp; &nbsp;
                        <input type="radio" id="radioketenagakerjaan" name="radiobpjs" class="form-check-input" value="3">&nbsp;<label for="radioketenagakerjaan" style="margin-top: 5px; font-size: 10px; font-weight: 700">Ketenagakerjaan</label>
                    </div> -->

                        <!-- KESEHATAN -->
                        <div id="kesehatan" class="col-12">
                            <div class="row p-3">
                                <div class="col-12">
                                    <p class="mb-0" style="font-size: 13px; font-weight: 400; color: rgb(136, 136, 136); margin-left: 3px">Nomor Virtual Account Keluarga / Perusahaan</p>
                                </div>
                                <div class="col-12">
                                    <input id="nomorva" class="mt-2" type="number" pattern="\d*" placeholder="Contoh 000001251025984" style="border: none; border-bottom: 2px solid var(--color-border,#E5E7E9); width: 100%">
                                </div>
                            </div>
                            <div class="row p-3">
                                <div class="col-12">
                                    <p style="font-size: 13px; font-weight: 400; color: rgb(136, 136, 136); margin-left: 3px; margin-top: -15px">Bayar Untuk</p>
                                    <select id="bpjs-kesehatan-select" style="margin-top: -10px; border: none; border-bottom: 2px solid var(--color-border,#E5E7E9)" class="form-select" aria-label="Default select example">
                                        <option value="" selected>Pilih Bulan</option>

                                        <?php foreach ($bulan as $b) : ?>

                                            <option value="<?= $b['CODE'] ?>"><?= $b['DENOM'] ?> Bulan</option>
                            ...
                            <div class="row p-4">
                                <div class="col-12 p-3" style="background-color: #ffe2e5; border: 0.5px solid #ed0226; border-radius: 3px">
                                    ...
                                    <br>
                                    <p class="mb-0" style="font-size: 12px; margin-top: -10px">Status tagihan BPJS akan diperbarui maks. 3x24 jam (hari kerja) setelah transaksi berhasil.</p>
                                    <!-- <p class="mb-0" style="font-size: 12px; margin-top: 15px; color: #ed0226; font-weight: 600">Daftar Auto Debet BPJS dapat dilakukan disini</p> -->
                                </div>
                            </div>
                            <div class="row p-3">
                                <div class="col-12">
                                    ...
                                    if ($env == 1) {
                                    ?>
                                        <button onclick="bpjsCheck()" id="bayar" class="btn" style="width: 100%; border: 1px solid #cacaca; color: white; background-color: #f06270">Cek Tagihan</button>
                                    <?php
                                    } else {
                                    ?>
                                        <button onclick="bpjsCheck()" id="bayar" class="btn" style="width: 100%; border: 1px solid #cacaca; color: white; background-color: red">Cek Tagihan</button>
                                    <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <!-- DENDA -->
                        <div id="denda" class="col-12" style="height: 476px">
                            <div class="row p-3">
                                <div class="col-12">
                                    <p class="mb-0" style="font-size: 13px; font-weight: 400; color: rgb(136, 136, 136); margin-left: 3px">Nomor Virtual Account Keluarga / Perusahaan</p>
                                </div>
                                <div class="col-12">
                                    <input id="nomorva-2" class="mt-2" type="number" placeholder="Contoh 000001251025984" style="border: none; border-bottom: 2px solid var(--color-border,#E5E7E9); width: 100%">
                                </div>
                            </div>
                            <div class="row p-4">
                                <div class="col-12 p-3" style="background-color: #ffe2e5; border: 0.5px solid #ed0226; border-radius: 3px">
                                    <p class="mb-0" style="font-size: 12px; color: #ed0226; font-weight: 600">Keterangan</p>
                                    <br>
                                    <p class="mb-0" style="font-size: 12px; margin-top: -10px; font-weight: 700">Silahkan masukkan 13 digit nomor VA BPJS sesuai dengan nomor kartu anda.</p>
                                </div>
                            </div>
                            <div class="row p-3">
                                <div class="col-12">
                                    <button id="bayar-none-2" class="btn btn-light" style="width: 100%; border: 1px solid #cacaca; color: #cacaca">Bayar</button>
                                    <button id="bayar-2" class="btn" style="width: 100%; border: 1px solid #cacaca; color: white; background-color: #ed0226">Bayar</button>
                                </div>
                            </div>
                        </div>

                        <!-- KETENAGAKERJAAN -->
                        <div id="tenagakerja" class="col-12" style="height: 476px">
                            <div class="row p-3">
                                <div class="col-12">
                                    <p class="mb-0" style="font-size: 13px; font-weight: 400; color: rgb(136, 136, 136); margin-left: 3px">Nomor KTP / Nomor Kartu Peserta</p>
                                </div>
                                <div class="col-12">
                                    <input id="nomorktp" class="mt-2" type="number" placeholder="Contoh 000001251025984" style="border: none; border-bottom: 2px solid var(--color-border,#E5E7E9); width: 100%">
                                </div>
                            </div>
                            <div class="row p-3">
                                <div class="col-12">
                                    <p style="font-size: 13px; font-weight: 400; color: rgb(136, 136, 136); margin-left: 3px; margin-top: -15px">Bayar Hingga</p>
                                    <select style="margin-top: -10px; border: none; border-bottom: 2px solid var(--color-border,#E5E7E9)" class="form-select" aria-label="Default select example">
                            ...
                            <div class="row p-4">
                                <div class="col-12 p-3" style="background-color: #ffe2e5; border: 0.5px solid #ed0226; border-radius: 3px">
                                    <p class="mb-0" style="font-size: 12px; color: #ed0226; font-weight: 600">Keterangan</p>
                                    <br>
                                    <p class="mb-0" style="font-size: 12px; margin-top: -10px">Pembayaran BPJS Ketenagakerjaan dapat dilakukan untuk peserta <span style="font-weight: 700">BPU (Peserta Individu)</span> dan <span style="font-weight: 700">Pekerja Migran Indonesia.</span></p>
                                    <p class="mb-0" style="font-size: 12px; margin-top: 15px">Untuk pembayaran iuran PU dan Jasa Konstruksi saat ini belum dapat dilakukan.</p>
                                </div>
                            </div>
                            <div class="row p-3">
                                <div class="col-12">
                                    <button id="bayar-none-3" class="btn btn-light" style="width: 100%; border: 1px solid #cacaca; color: #cacaca">Bayar</button>
                                    <button id="bayar-3" class="btn" style="width: 100%; border: 1px solid #cacaca; color: white; background-color: #ed0226">Bayar</button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-12 d-flex justify-content-center">
            <div class="row gx-0 p-3" style="width: 100%; margin-top: -15px">
                ...
                <div class="col-2 d-flex justify-content-end" style="position:relative">
                    ...
                    if ($env == 1) {
                    ?>
                        <button class="btn text-light" style="background-color: #f06270; position:absolute; bottom:0;" onclick="purchaseBPJS()">Bayar</button>
                    <?php
                    } else {
                    ?>
                        <button class="btn text-light" style="background-color: red; position:absolute; bottom:0;" onclick="purchaseBPJS()">Bayar</button>
                    <?php
                    }
                    ?>
                </div>
...
<script>
    ...
    $("#radiokesehatan").change(function() {
        $("#kesehatan").show();
        $("#denda").hide();
        $("#tenagakerja").hide();
        $("#bayar-none").show();
    ...
    $("#radioketenagakerjaan").change(function() {
        $("#kesehatan").hide();
        $("#denda").hide();
        $("#tenagakerja").show();
        $("#bayar-none-3").show();
    ...
    $("#nomorva").bind("change space keyup", function() {
        var va = $(this).val();
        var bpjs = $("#bpjs-kesehatan-select").val();
    ...
    $("#bpjs-kesehatan-select").change(function() {
        var bpjs = $(this).val();
        var va = $("#nomorva").val();
    ...
    function bpjsCheck() {
        ...
        var command = "INQUIRY";
        var product = $('#bpjs-kesehatan-select').val();
        var customer = $('#nomorva').val();
    ...
    $("#nomorva-2").bind("change space keyup", function() {
        var va = $(this).val();
    ...
    $("#bayar-2").click(function() {
        $("#checkout").show();
    });

    $("#nomorktp").bind("change space keyup", function() {
        var ktp = $(this).val();
