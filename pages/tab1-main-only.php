        ...
        xmlHttp.onreadystatechange = function() {
          if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
            ...
            if (xmlHttp.responseText == "1") {
              window.location = "tab5-new-post?f_pin=" + f_pin + "&origin=0";
              localStorage.setItem("is_grid", "0");
              localStorage.setItem('activeQueryTimeline', window.location.search);
            } else {
              if (window.Android) {
