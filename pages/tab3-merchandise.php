...
<body class="tab3">
    ...
    <div class="modal fade" id="modal-product" tabindex="-1" aria-labelledby="modal-product" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-start" style="height:175px; overflow-y:auto;"></div>
            </div>
        </div>
    </div>
    <!-- show product modal -->
  ...
  <div class="modal fade" id="modal-delete-question" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <h6 id="text-delete-content-merchandise-bi">Which content you want to delete?</h6>
                </div>
                <div class="modal-footer">
                    <button id="just-post" type="button" class="btn btn-addcart d-none">Just Post</button>
...
<script type="text/javascript" src="../assets/js/script-merchandise.js?random=<?= time(); ?>" defer></script>
...
<script>
    ...
    if (localStorage.lang == 1) {
        ...
        $("#text-delete-content-merchandise-bi").text("Konten mana yang ingin anda hapus?");
