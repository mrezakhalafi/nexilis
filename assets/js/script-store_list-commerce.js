...
//     console.log(imageArray);
    if(!imageArray || imageArray.length == 0){
      ...
      if (!shop_thumb.startsWith("http")) {
        let shoppic = "/nexilis/images/" + shop_thumb;
    ...
    if (element.LINK == null || element.LINK == '' || element.LINK == undefined || element.BE_ID != null) {
      ...
      merchantWebURL = 'tab3-profile.php?store_id=' + element.CREATED_BY + '&f_pin=' + f_pin;
...
//       console.log('here');
      ...
      var computed =
        ...
        '</div>' +
        '</div>' +
        '<div class="icon-merchant"><img src="/nexilis/assets/img/icons/Verified-(Black).png" ' + (element.BE_ID != null ? '' : ' class="d-none"') + '/><div class="merchant-name">' + element.NAME + '</div></div>' + 
